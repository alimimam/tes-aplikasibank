...
<body class="bg-gray-100">
    <div class="dashboard-container bg-white shadow-lg min-h-screen flex flex-col">
        ...
        <div class="bg-white p-4 border-b">
            <div class="bg-purple-300 rounded-lg p-4 border-b">        
        ...
        <div class="flex-grow p-4">
            ...
            <form method="POST" action="" class="space-y-4">
                ...
                <button type="submit" class="w-full p-3 bg-purple-600 text-white rounded-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                    Kirim Uang
                </button>
            </form>
        </div>
